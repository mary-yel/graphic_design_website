    ...
    return (
        <div className="seed-page-container">
            ...
            <section className="seed-resumen-section">
                <ShortSeed title="IMAGO" descp="Reflexionar sobre el patrimonio y la transmisión de valores culturales por medio de las tradiciones, mitos y leyendas del departamento del Cesar a partir de las herramientas del diseño gráfico." date="Creación: 30/08/2022" imagen={ImagoLogo}/>
                <ShortSeed title="CÁMARA OSCURA" descp="Registrar y difundir información sobre el patrimonio cultural, expresiones culturales, mitos y leyendas del Departamento del César a través de la producción audiovisual y fotográfica con el fin de preservar y promover la identidad cultural de la región." date="Creación: 21/03/2023" imagen={COscuraLogo}/>
            </section>

            <section className="seed-section">
                <h1>¿Quieres saber <span className="highlight">aún más?</span></h1>
            </section>

            <section className="seed-detail-section">
                < LongSeed logo={ImagoLogo} descp="Imago busca aportar al departamento del Cesar con una mirada innovadora del diseño como herramienta que enriquezca y resalte la cultura, que contribuya al desarrollo sustentable y sociable del patrimonio oral y cultural." etiquetas={["Patrimonio", "Diseño"]} galeria={[ImagoImagen1, ImagoImagen2]} feed={ImagoImagen3} url={"https://www.instagram.com/sem.imago/"}/>
                < LongSeed logo={COscuraLogo} descp="Cámara Oscura Preservar y promover la identidad cultural del César a través de la producción audiovisual y fotográfica, destacando su patrimonio, expresiones culturales, mitos y leyendas." etiquetas={["Exploración", "Difusión"]} galeria={[COscuraImagen1, COscuraImagen2]} feed={COscuraImagen3} url={""}/>
            </section>
